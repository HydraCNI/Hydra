module github.com/hydra-cni/hydra
...
require k8s.io/endpointslice v0.0.0
...
//replace k8s.io/kubeclient => k8s.io/kubeclient v0.28.0
...
replace k8s.io/endpointslice v0.0.0 => ./staging/k8s.io/endpointslice
