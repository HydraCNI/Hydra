...
func (e *Controller) syncService(ctx context.Context, key string) error {
	...
	if err != nil {
		...
		err = e.client.CoreV1().Endpoints(namespace).Delete(ctx, fmt.Sprintf("clusternet-%v", name), metav1.DeleteOptions{})
	...
	endpointsNamespaceName := types.NamespacedName{
		Name:      fmt.Sprintf("clusternet-%v", service.Name),
	...
	if err != nil {
		...
		currentEndpoints = &v1.Endpoints{
			ObjectMeta: metav1.ObjectMeta{
				Name:   endpointsNamespaceName.Name,
